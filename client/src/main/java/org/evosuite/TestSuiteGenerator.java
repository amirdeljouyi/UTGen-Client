...
//        llm.improveUnderstandability();
     ...
     */
    public static TestGenerationResult writeJUnitTestsAndCreateResult(TestSuiteChromosome testSuite, Boolean toImprove, String suffix) {
        ...
        if (Properties.JUNIT_TESTS) {
            ...
            suiteWriter.writeTestSuite(name + suffix, testDir, testSuite.getLastExecutionResults(), toImprove);
        }
     ...
     */
    public static TestGenerationResult writeJUnitTestsAndCreateResult(TestSuiteChromosome testSuite, Boolean toImprove) {
        return writeJUnitTestsAndCreateResult(testSuite, toImprove, Properties.JUNIT_SUFFIX);
    }
